    ...
    <main className="min-h-screen bg-gradient-to-br from-emerald-50 via-white to-green-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:flex gap-8">
              ...
              <Link href="/blog" className="text-gray-700 hover:text-emerald-600 transition font-medium text-sm">Blog</Link>
      ...
      <section className="py-16 px-4 sm:py-24 bg-white">
        <div className="max-w-6xl mx-auto">
          <div className="flex justify-between items-center mb-12">
            <div>
              <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-2">Latest Articles</h2>
              <p className="text-gray-600">Health tips and wellness information</p>
            </div>
            <Link href="/blog" className="text-emerald-600 hover:text-emerald-700 font-semibold flex items-center gap-2">
              Read All <ChevronRight size={20} />
            </Link>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {blogPosts.map((post) => (
                <Link key={post._id} href={`/blog/${post.slug}`} className="group">
                  <div className="bg-gray-100 rounded-xl h-48 mb-4 group-hover:shadow-lg transition"></div>
                  <h3 className="font-semibold text-gray-900 group-hover:text-emerald-600 transition mb-2">{post.title}</h3>
